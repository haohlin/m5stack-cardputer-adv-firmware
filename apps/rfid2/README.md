...
Run from the monorepo root. On device: Launcher → Settings → USB MSC; stage raw
app image; exit USB MSC; select it under `tools/`; choose Install. Launcher
stays installed and owns OTA updates.
...
1. Install the firmware through Launcher OTA.
